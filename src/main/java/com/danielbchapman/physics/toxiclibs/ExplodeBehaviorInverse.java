 ...
 *
 */
public class ExplodeBehaviorInverse extends MotionInteractiveBehavior
{
...
//  protected Vec3D direction;
  ...
  public ExplodeBehaviorInverse()
  {
    this(new Vec3D(), 0f);
  }
  
  public ExplodeBehaviorInverse(Vec3D direction, float magnitude)
  {
  ...
  {
    return "Inverse Explode Behavior";
  }
  ...
  {
    ExplodeBehaviorInverse copy = new ExplodeBehaviorInverse();
    copy.vars = vars.copy();
