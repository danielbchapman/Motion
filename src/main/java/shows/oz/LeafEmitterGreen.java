...
public class LeafEmitterGreen extends AbstractEmitter<Leaf>
{
  static PShape[] leafShapes;
  Motion motion;
  
  public LeafEmitterGreen(Motion motion, VerletPhysics3D physics, Vec3D position, Vec3D heading, int lifeSpan, int rate, float randomVector, int randomTime)
  {
  ...
  public void draw(PGraphics g)
  {
    if(leaf == null)
    {
      leaf = motion.loadImage("content/leaves/test-leaf-green.png");
    }
    if(leafShapes == null)
    {
      initializeLeaves(g);
