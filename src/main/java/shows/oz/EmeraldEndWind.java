...
public class EmeraldEndWind extends PhysicsScene
{
  ...
  ArrayList<LeafEmitterGreen> topLeaves = new ArrayList<>();
  ArrayList<LeafEmitterGreen> leftLeaves = new ArrayList<>();
  ArrayList<LeafEmitterGreen> rightLeaves = new ArrayList<>();

  SimpleWindBehavior wind = new SimpleWindBehavior(new Vec3D(-0.03f, 0, 0));
  PlaybackCue flutter;
  @Override
  public void initialize(Motion motion)
  {
    ...
    for(int i = -2; i < Motion.WIDTH / 50; i++)
    {
      ...
      LeafEmitterGreen e = new LeafEmitterGreen(motion, physics, pos, wind, 5000, 100, 2f, 100);  
    ...
    for(int i = 0; i < heightCells; i++)
    {
      ...
      LeafEmitterGreen e = new LeafEmitterGreen(motion, physics, pos, wind, 20000, 100, 2f, 100);  
      e.physics = this.physics;
      leftLeaves.add(e);
    }
